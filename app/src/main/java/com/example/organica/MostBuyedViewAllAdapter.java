...
public class MostBuyedViewAllAdapter extends RecyclerView.Adapter<MostBuyedViewAllAdapter.ViewHolder> {
    private static final String Tag="RecyclerView";
    private  Context context;
    DatabaseReference myref = FirebaseDatabase.getInstance().getReference().child("Sellers");
    private ArrayList<BuyedHelperViewAll> iteminfolist;
    onClickInterface onClickInterface;

    public MostBuyedViewAllAdapter(Context c,ArrayList<BuyedHelperViewAll> a,onClickInterface onClickInterface){
        this.context=c;
        this.iteminfolist=a;
    ...
    @NonNull
    @Override
    public MostBuyedViewAllAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.most_buyed_viewall,parent,false);
