...
public class BuyedHelperViewAll implements Comparable<BuyedHelperViewAll> {
    ...
    public int item_buy_count;

    public BuyedHelperViewAll() {
    }
    ...
    public BuyedHelperViewAll(String seller_username, String item_name, String item_rate, String available_units, String item_category, String item_image_url, int item_buy_count){
    ...
    @Override
    public int compareTo(BuyedHelperViewAll buyedHelperViewAll) {
        return buyedHelperViewAll.item_buy_count - this.item_buy_count;
    }
}
